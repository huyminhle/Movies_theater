...
<head>
    ...
    <title>Active Promotions — CGV Admin</title>
...
<div class="cgv-main">
    ...
    <header class="cgv-header">
        <h1 class="cgv-header-title">Active Promotions</h1>
    ...
    <div class="cgv-page">
        <div class="cgv-table-wrap">
            ...
            <div class="cgv-toolbar">
                <div class="cgv-pills">
                    ...
                    <a href="${pageContext.request.contextPath}/manager/promotions?view=active" class="cgv-pill active">Active</a>
                ...
                <table class="cgv-dt">
                    ...
                    <tbody>
                        <c:choose>
                            <c:when test="${not empty promotions}">
                                <c:forEach var="p" items="${promotions}" varStatus="st">
                                    <tr>
                                        ...
                                        <td>
                                            <span style="font-weight:600;">${p.usedCount}</span>
                                            / ${not empty p.usageLimit ? p.usageLimit : '∞'}
                                        </td>
                                        <td>
                                            <div style="display:flex;gap:6px;flex-wrap:wrap;">
                                                <form method="post" style="display:inline;">
                                                    ...
                                                    <button type="submit" class="btn--cgv-outline"
                                                            style="color:#c17900;border-color:#c17900;"
                                                            onclick="return confirm('Deactivate ${p.promotionCode}?')">Deactivate</button>
                                                </form>
                            ...
                            <c:otherwise>
                                <tr><td colspan="10" style="text-align:center;padding:48px;color:rgba(94,63,58,0.4);">No active promotions.</td></tr>
                            </c:otherwise>
                        </c:choose>
                    </tbody>
                </table>
        ...
        <aside class="cgv-aside">
            <div class="cgv-stats-section">
                <div class="cgv-aside-heading">ACTIVE OVERVIEW</div>
                <div class="cgv-stats-group">
                    <div>
                        <div class="cgv-stat-num">${not empty totalItems ? totalItems : '0'}</div>
                        <div class="cgv-stat-key">TOTAL ACTIVE</div>
                    </div>
                    <div>
                ...
                <div style="margin-top:20px;font-size:12px;color:rgba(94,63,58,0.6);line-height:1.6;border-top:1px solid var(--cgv-border);padding-top:16px;">
                    <strong>Deactivate</strong> — pauses a running promotion (sets to Inactive).<br><br>
                    <strong>Edit</strong> — code, type and value are locked if the promotion has been used; description, end date and usage limit remain editable.
                </div>
            </div>
        </aside>
    </div>
